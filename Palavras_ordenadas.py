'''Escreva um programa, da forma mais reduzida o possível, que recebe do usuário uma série de nomes, separando os mesmos e os organizando em ordem alfabética. Em seguida, exiba em tela os nomes já ordenados. 
 '''
...
do processo, cada nome como um dos elementos da lista atribuída a nomes.
...
Por fim, por meio da função print( ), parametrizada com ‘, ‘;joint( ) por sua vez parametrizada com o conteúdo da variável nomes, novamente estamos concatenando tais nomes para exibi-los em tela, agora reordenados conforme pedido no enunciado da questão.
